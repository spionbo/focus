...
exports.default = {
    ...
    computed: (0, _vuex.mapState)(['status']),
    props: {
        transition: String
    },
    methods: {
...
Component.options.__file = "E:\\work\\pc\\activity\\app\\guhuaDafuweng\\src\\pop\\notStart.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c1bb27c", Component.options)
  } else {
    hotAPI.reload("data-v-6c1bb27c", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('pop', {
    ...
    slot: "body"
  }, [_c('h2', [_vm._v("感谢关注")]), _vm._v(" "), (_vm.status == -1) ? _c('div', [_c('p', [_vm._v("本次活动尚未开始")]), _c('p', [_vm._v("敬请期待")])]) : _c('div', [_vm._v("本次活动已结束")])]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6c1bb27c", module.exports)
  }
}
...
//# sourceMappingURL=10_chunk.js.map?name=67553faf61540dba269b