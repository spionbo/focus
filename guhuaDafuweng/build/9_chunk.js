...
exports.default = {
    ...
    computed: (0, _vuex.mapState)(['evenNumbersDice', 'oddNumbersDice']),
    data: function data() {
        return {
...
Component.options.__file = "E:\\work\\pc\\activity\\app\\guhuaDafuweng\\src\\pop\\selectScene.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-63096d53", Component.options)
  } else {
    hotAPI.reload("data-v-63096d53", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('pop', {
    ...
    slot: "header"
  }, [_c('h2', [_vm._v("请选择骰子")])]), _vm._v(" "), _c('div', {
    staticClass: "img-size",
    attrs: {
      "data-paddingTop": "10",
  ...
  }), _vm._v(" "), _c('p', [_vm._v("剩余" + _vm._s(_vm.oddNumbersDice) + "次机会")])]) : _vm._e(), _vm._v(" "), (_vm.evenNumbersDice > 0) ? _c('div', {
    staticClass: "right-slide"
  }, [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }), _vm._v(" "), _c('p', [_vm._v("剩余" + _vm._s(_vm.evenNumbersDice) + "次机会")])]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "submit",
    slot: "footer"
  }, [_c('p', {
    staticClass: "tips"
  }, [_vm._v(_vm._s(_vm.P.tips))])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-63096d53", module.exports)
  }
}
...
//# sourceMappingURL=9_chunk.js.map?name=67553faf61540dba269b