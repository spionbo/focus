...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webpackZepto = __webpack_require__(9);
	...
	var _vueAnimatedList = __webpack_require__(10);
	...
	var _top = __webpack_require__(15);
	...
	var _loadding = __webpack_require__(29);
	...
	var _callApp = __webpack_require__(30);
	
	var _callApp2 = _interopRequireDefault(_callApp);
	
	var _wechatShare = __webpack_require__(31);
	
	var _wechatShare2 = _interopRequireDefault(_wechatShare);
	
	var _draw3 = __webpack_require__(24);
	...
	exports.default = {
		...
		methods: {
			questions: function questions(event, name, id) {
				var self = this;
				(0, _draw3.pop)('活动还未开始！请在活动开始后进行问股！');
				return;
				_global2.default.btnEvent.call(event.target, function () {
					if (loginStatus == 0) {
						...
						_callApp2.default.login(-1);
					} else if (loginStatus == -2) {
						_callApp2.default.login(-2);
					}
				});
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	  ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.VueAnimatedList = factory();
	})(undefined, function () {
	  'use strict';
	...
	exports.default = {
		...
		ready: function ready() {
			...
			function updateNum() {
				...
				if (self.askNum == 1000) {
					(0, _draw.start)('.luck-draw .submit .btn', self.$parent.question);
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var D = {
		...
		start: function start(btn, status) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var T = {
		...
		init: function init(obj) {
			...
			var popUrl = ['newtcphone.png' //下载爱投顾
			, 'share.png' //分享 邀请码
			, 'share1.png' //分享
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadJs = __webpack_require__(32);
...
/***/ }
/******/ ]);
//# sourceMappingURL=main.js.map?c9a7935a8e4b3d3fb260