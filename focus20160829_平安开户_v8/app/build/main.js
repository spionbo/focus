...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_chunk.js";
...
/******/ 	__webpack_require__.p = "http://10.66.5.205:801/focus20160829_%E5%B9%B3%E5%AE%89%E5%BC%80%E6%88%B7_v8/app/build/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	{
		(function () {
			var share = window.shareInfo;
			_global2.default.init({
				loadDone: function loadDone() {
					var _this = this;
	
					var wrap = (0, _webpackZepto2.default)('.container');
					wrap.css3({ transform: 'translateY(0px)', opacity: 1 });
					{
						//微信平台分享
						if (_global2.default.weixin) {
							__webpack_require__.e/* nsure */(2, function () {
								var InitWeChatShare = __webpack_require__(8);
								InitWeChatShare({
					...
					{
						//分享
						var p = new _pop2.default();
						p.share('.share-btn', share);
					}
					{
						//点击事件
						(0, _webpackZepto2.default)('.main .btn1').click(function () {
							_global2.default.btnEvent.call(_this, function () {
								__webpack_require__.e/* nsure */(3, function () {
									var callApp = __webpack_require__(15);
									callApp.openList();
								});
							});
							window.dcsMultiTrack('DCS.dcsuri', 'ITOUGU_focus20160830_OPEN', 'WT.ti', 'ITOUGU_focus20160830_OPEN');
						});
						(0, _webpackZepto2.default)('.leve_btn').click(function () {
							var p1 = new _pop2.default();
							p1.text();
	...
	var T = {
		...
		setImgSize: function setImgSize() {
			...
			(0, _webpackZepto2.default)('.img-size').each(function () {
				...
				_webpackZepto2.default.each(['data-height', 'data-width', 'data-left', 'data-right', 'data-bottom', 'data-top', 'data-marginTop', 'data-paddingTop', 'data-paddingLeft', 'data-paddingRight', 'data-marginLeft', 'data-marginRight'], function (i, str) {
					...
					if (num) {
						...
						if (str == 'data-marginRight') self.css({ marginRight: num });
		...
		unbind: function unbind(time, callback) {
			time = time || 3;
			var self = (0, _webpackZepto2.default)(this),
			    index = 0,
			    _tim1;
			self.data('unbindBtn', false);
			self.addClass('gray');
			function go() {
				index++;
				if (index >= time) {
					clearTimeout(_tim1);
					self.data('unbindBtn', true);
					self.removeClass('gray');
					if (callback && _webpackZepto2.default.type(callback) == 'function') {
						callback();
					}
				} else {
					_tim1 = setTimeout(go, 1000);
				}
			}
			go();
		},
		btnEvent: function btnEvent(callback, _url) {
			var url = {
				weixin_ios: "http://sjcms.jrj.com.cn/app_tg.php?channel=V4V6497Y9&tgqdcode=3Q2Y3H95",
				ios: 'http://sjcms.jrj.com.cn/app_tg.php?channel=V4V6497Y9&tgqdcode=3Q2Y3H95',
				android: 'http://sjcms.jrj.com.cn/app_tg.php?channel=V4V6497Y9&tgqdcode=3Q2Y3H95',
			...
			if ((0, _webpackZepto2.default)(this).data('unbindBtn') == false) return;
			T.unbind.call(this);
			...
			if (len) {
				img.each(function (i) {
					...
					oImage.onload = function () {
						...
						if (count == len) {
							oLoadingBox.remove();
							(0, _webpackZepto2.default)('.remove-hide').remove();
							T.body.css({ 'height': 'auto', 'overflowY': 'auto' });
							img.each(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		_createClass(Pop, [{
			key: 'init',
			value: function init() {
				var ele = (0, _webpackZepto2.default)("<div class='pop'>" + "<div class='pop-cnt'>" + "<div class='close'><div class='v-line'></div><div class='h-line'></div></div>" + "<div class='content'></div>" + "</div>" + "</div>");
	
				_webpackZepto2.default.extend(this.config, {
					elem: ele,
			...
			value: function add(fn) {
				...
				if (!ele.elem.parent().length) {
					...
					ele.close.click(function (event) {
						self.close();
						event.stopPropagation();
					});
					ele.elem.click(function () {
						return self.close();
					});
					ele.bg.click(function (e) {
			...
			key: 'share',
			value: function share(_btn, _share) {
				//分享按钮
				var btn = (0, _webpackZepto2.default)(_btn);
				var self = this;
				if (_global2.default.Itougu) {
					btn.click(function () {
						_global2.default.btnEvent.call(this, function () {
							var href = 'http://www.itougu.com/?share={"title":"' + encodeURI(_share.title) + '","content":"' + encodeURI(_share.content) + '","url":"' + encodeURI(_share.url) + '","imgurl":"' + encodeURI(_share.pic) + '"}';
					...
					__webpack_require__.e/* nsure */(1, function () {
						var btn = (0, _webpackZepto2.default)(_btn);
						var nativeShare = __webpack_require__(7);
						var share_obj = new nativeShare({
							...
							callback: function callback() {
								return self.add(function () {
									var text = "<div class='pop-share'>" + '<h3>分享到：</h3>' + "<ul>" + "<li data-app='sinaWeibo'><i class='weibo'></i><p>微博</p></li>" + "<li data-app='weixin'><i class='weixin'></i><p>微信</p></li>" + "<li data-app='weixinFriend'><i class='weixin_friend'></i><p>朋友圈</p></li>" + "<li data-app='QQ'><i class='qq'></i><p>QQ好友</p></li>" + "<li data-app='QZone'><i class='qq_zone'></i><p>QQ空间</p></li>" + "<li data-app=''><i class='more'>●●●</i><p>更多</p></li>" + "</ul>" + "</div>";
									return text;
								});
							}
						});
			...
			value: function text() {
				//文字说明
				this.add(function () {
					var text = "<div class='text'>" + "<p>请在网页端爱投顾官网：http://itougu.jrj.com.cn/  的“平安证券开户交易活动”入口进入，点击“免费领取Level-2”按钮进行下载使用。</p>" + "<p class='explain'>说明：Level-2 只赠送PC端的免费使用权，手机端产品不在本次活动赠送范围。</p>" + "</div>";
					return text;
				});
			}
		}]);
